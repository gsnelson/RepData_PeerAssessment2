...
```{r check for duplicated rows, echo = TRUE, results = "hide"}
...
``` {r reassign rows with Other EVTYPE}
...
```{r normalize property damage estimates}
...
```{r normalize crop damage estimates}
